...
import com.revature.daos.UserInventoryPostgres;
...
public class MainuTest {
	...
	static UserInventoryPostgres uid = new UserInventoryPostgres();
	static User u;
	
	//Work on Logging
	private static Logger log = LogManager.getLogger(MainuTest.class);
	...
	public static String makeAccount() throws LoginException {
	...
	public static String login() throws LoginException {
